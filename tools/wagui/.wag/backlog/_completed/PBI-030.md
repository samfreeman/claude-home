...
- [x] Load filter config on server startup
- [x] Apply `skipIfStartsWith` patterns
- [x] Apply `skipIfContains` patterns
- [x] Apply `stripPatterns` as regex replacements
- [x] Existing hardcoded filters moved to config
- [x] Tests for filter loading and application
