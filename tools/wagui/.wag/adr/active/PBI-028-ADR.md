...
- [ ] Command invocation messages filtered out
- [ ] IDE event messages filtered out
- [ ] Context compaction transformed to brief summary
- [ ] System reminder tags stripped from content
- [ ] User messages with system-injected tags not attributed to user
- [ ] Tests written for filtering logic
